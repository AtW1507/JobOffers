package com.junioroffer.infrastructure.offer.scheduler;
...
public class OfferScheduler {
    ...
    @Scheduled(fixedDelayString = "${offer.fetcher-offer.scheduler.delay}")
    public List<OfferResponseDto> fetchAllOffersAndSaveAllIfNotExists(){
        log.info(STARTED_OFFERS_FETCHING_MESSAGE, dataFormat.format(new Date()));
        ...
        log.info(STOPPED_OFFERS_FETCHING_MESSAGE, dataFormat.format(new Date()));
        return addedOffers;
    }
}
