package com.JobOffers.cacheredis;
...
class RedisOffersCacheIntegrationTest extends BaseIntegrationTest {
    ...
    public static void propertyOverride(DynamicPropertyRegistry registry) {
        registry.add("spring.data.redis", () -> REDIS.getFirstMappedPort().toString());
    ...
    public void should_save_offers_to_cache_and_then_invalidate_by_time_to_live() throws Exception {
        ...
        // given && then
        ResultActions resultAction = mockMvc.perform(post("/register")
                .content("""
                        {
                        "userName": "someUser",
